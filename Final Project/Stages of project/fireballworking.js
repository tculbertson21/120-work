...
function setup(){
  ...
  jasmine[0][3] = new Jasmine(pos_x, pos_y, 99, 121, jas5_img);
  jasmine[0][4] = new Jasmine(pos_x, pos_y, 108, 156, jas6_img);
...
class Jasmine{
  ...
  display(x, y){
    ...
    //if (orientation === 0) {
            //scale(1,1);
        //} else if (i = 4 && orientation == 1){
          //scale(-1, 1);
          //his.size.w = -this.size.w;
